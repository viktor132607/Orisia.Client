  ...
  return (
    <div className="fixed inset-0 z-[10000] overflow-hidden bg-[#0c0704]" aria-label={isBg ? "Вход към ОРИСИЯ" : "Entrance to ORISIA"}>
      <div className="relative h-full w-full overflow-hidden border-[6px] border-[#6f4929]">
        ...
        <div className={`absolute inset-y-0 left-0 z-10 w-1/2 origin-left border-r border-[#9b6b38] bg-[#64391e] transition-transform duration-500 ease-in-out ${open ? "-translate-x-[105%]" : "translate-x-0"}`} aria-hidden="true">
        ...
        <div className={`absolute inset-y-0 right-0 z-10 w-1/2 origin-right border-l border-[#9b6b38] bg-[#64391e] transition-transform duration-500 ease-in-out ${open ? "translate-x-[105%]" : "translate-x-0"}`} aria-hidden="true">
